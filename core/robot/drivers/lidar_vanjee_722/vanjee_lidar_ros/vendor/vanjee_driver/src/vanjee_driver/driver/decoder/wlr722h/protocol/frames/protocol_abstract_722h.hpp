...
namespace vanjee {
namespace lidar {
class ProtocolAbstract722H : public ProtocolAbstract {
 public:
  ProtocolAbstract722H(const std::shared_ptr<CmdClass> sp_cmd, std::shared_ptr<ParamsAbstract> content, uint8 checkType = 1, uint8 type = 0)
