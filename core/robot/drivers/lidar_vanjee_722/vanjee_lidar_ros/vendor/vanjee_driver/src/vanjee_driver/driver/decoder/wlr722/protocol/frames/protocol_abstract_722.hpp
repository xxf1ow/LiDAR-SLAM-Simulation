...
namespace vanjee {
namespace lidar {
class ProtocolAbstract722 : public ProtocolAbstract {
 public:
  ProtocolAbstract722(const std::shared_ptr<CmdClass> sp_cmd, std::shared_ptr<ParamsAbstract> content, uint16 idx = 0, uint32 timestamp = 0,
