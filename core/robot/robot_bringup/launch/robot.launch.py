...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("lidar_scan_lines", default_value="16"),
        DeclareLaunchArgument("lidar_columns_per_scan", default_value="1800"),
        DeclareLaunchArgument("lidar_scan_rate_hz", default_value="10"),
        DeclareLaunchArgument("lidar_min_range", default_value="0.9"),
        DeclareLaunchArgument("lidar_max_range", default_value="100.0"),
        DeclareLaunchArgument("lidar_horizontal_start_angle", default_value="-3.14159"),
        DeclareLaunchArgument("lidar_horizontal_end_angle", default_value="3.14159"),
        DeclareLaunchArgument("imu_rate_hz", default_value="200"),
    ]
